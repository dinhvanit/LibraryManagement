...
public class Thesis extends Document {
     ...
     */
    public Thesis(String id, String title, String author, String category, int quantity, boolean isAvailable, String university, String supervisor, String researchArea) {
